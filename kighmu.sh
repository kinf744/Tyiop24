    ...
    while true; do
        ...
        case $SUB in
            1) clear; echo -e "${CYAN}━━ Création compte SSH ━━${RESET}"; read -rp "  Username: " u; read -rp "  Password: " p; read -rp "  Expire (jours): " e; if useradd -e "$(date -d "+${e}days" +%Y-%m-%d)" -s /bin/bash "$u" 2>/dev/null && echo "$u:$p" | chpasswd; then
                ...
                clear
                echo "✨  𝙉𝙊𝙐𝙑𝙀𝘼𝙐 𝙐𝙏𝙄𝙇𝙄𝙎𝘼𝙏𝙀𝙐𝙍 𝘾𝙍𝙀𝙀  ✨"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo "🔐 𝙋𝙊𝙍𝙏𝙎 𝘿𝙄𝙎𝙋𝙊𝙉𝙄𝘽𝙇𝙀𝙎 :"
                echo "∘ SSH: 22          ∘ System-DNS: 53"
                echo "∘ SSH WS: 80      ∘ DROPBEAR: 109   ∘ SSL: 444"
                echo "∘ BadVPN: 7100, 7200, 7300"
                echo "∘ SLOWDNS: 5300    ∘ UDP-Custom: 1-65535"
                echo "∘ WS-epro: 80  ∘ Proxy WS: 9090"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo "🌍 𝘿𝙊𝙈𝘼𝙄𝙉𝙀 : $D"
                echo "📌 𝙄𝙋 𝙃𝙊𝙎𝙏 : $IP"
                echo "👤 𝙐𝙏𝙄𝙇𝙄𝙎𝘼𝙏𝙀𝙐𝙍 : $u"
                echo "🔑 𝙈𝙊𝙏 𝘿𝙀 𝙋𝘼𝙎𝙎𝙀 : $p"
                echo "📦 𝙇𝙄𝙈𝙄𝙏𝙀 : $e"
                echo "📅 𝘿𝘼𝙏𝙀 𝘿'𝙀𝙓𝙋𝙄𝙍𝘼𝙏𝙄𝙊𝙉 : $E"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo "📲 𝘼𝙋𝙋𝙎 : HTTP Injector, CUSTOM, SOCKSIP TUNNEL, SSC ZIVPN, etc."
                echo "➡️ 𝙎𝙎𝙃 𝙒𝙎 : ${D}:80@${u}:${p}"
                echo "➡️ 𝙎𝙎𝙇/𝙏𝙇𝙎 : ${D}:444@${u}:${p}"
                echo "➡️ 𝙋𝙍𝙊𝙓𝙔 𝙒𝙎 : ${D}:9090@${u}:${p}"
                echo "➡️ 𝙎𝙎𝙃 𝙐𝘿𝙋 : ${D}:1-65535@${u}:${p}"
                echo "📜 𝙋𝘼𝙔𝙇𝙊𝘼𝘿 𝙒𝙎:"
                echo "GET / HTTP/1.1[crlf]Host: [host][crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                echo "🚀 𝘾𝙊𝙉𝙁𝙄𝙂 𝙁𝘼𝙎𝙏𝘿𝙉𝙎 (5300)"
                echo "🔐Pub KEY:"
                echo "$KEY"
                echo "NameServer:"
                echo "$NS"
                echo "✅  𝘾𝙊𝙈𝙋𝙏𝙀 𝘾𝙍𝙀𝙀 𝘼𝙑𝙀𝘾 𝙎𝙐𝘾𝘾𝙀𝙎"
                echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
